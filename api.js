 // Api Key :a143c86c7d3ec2cf97194e9a424726d2
...
const GetWeather =  (City) =>{
    ...
    const url=`https://api.openweathermap.org/data/2.5/weather?q=${City}&appid=a143c86c7d3ec2cf97194e9a424726d2`;
    ...
    .catch(()=>{
        ErrorMsg.style.opacity = 1;
        ErrorMsg.style.backgroundColor ="red";
        ErrorMsg.innerHTML =`${City} Please Enter Valid  City Name`;
        SearchCity.focus();
        SearchCity.value = "";
        HideErrorMsg();
    })
